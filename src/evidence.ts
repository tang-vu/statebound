...
import { check,type Result,DEFAULT_BOUNDS } from './checker.js';
import { replay,MODEL } from './simulator.js';
...
export function bundle(mandate:Mandate,plan:Plan,mode:'baseline'|'guarded',provenance:Provenance,original?:Plan) {
  ...
  const payload={version:VERSION,model:MODEL,capabilities,mandate,plan,original:original??plan,mode,provenance,dataSource:'synthetic fixture',execution:'simulator',result};
